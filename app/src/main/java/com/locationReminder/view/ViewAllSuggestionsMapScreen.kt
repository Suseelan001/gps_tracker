...
@Composable
fun ViewAllSuggestionsMapScreen(
    ...
    if (showMap) {
        HomeViewAllSuggestionsMapScreen(navHostController, categoryId,addLocationViewModel,suggestionsViewModel)
    }
}
...
@Composable
fun HomeViewAllSuggestionsMapScreen(
    navHostController: NavHostController,
   categoryId:String,addLocationViewModel: AddLocationViewModel,suggestionsViewModel:SuggestionsViewModel)
{
    ...
    val entryList by suggestionsViewModel.suggestionsList.observeAsState(emptyList())
